...
resource "aws_subnet" "public" {
  ...
  vpc_id = aws_vpc.main.id
  #cidrsubnet(var.vpc_cidr, 8, count.index) → Automatically calculates subnet ranges
  cidr_block        = cidrsubnet(var.vpc_cidr, 8, count.index)
  availability_zone = var.availability_zones[count.index]
  #map_public_ip_on_launch = true → Any server launched here automatically gets a public IP
...
# CloudWatch Interface Endpoint (Highest Priority)
...
# CloudWatch Logs Interface Endpoint (Application Logging)
